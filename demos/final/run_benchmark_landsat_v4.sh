...
# Command: bash demos/run_benchmark_landsat_v4.sh

SCRIPT_PATH="allclear/benchmark.py"
BASELINE_BASE_PATH='/share/hariharan/ck696/allclear/baselines/UnCRtainTS'
DATASET_PATH="/share/hariharan/cloud_removal/metadata/v4/s2p_tx3_test_3k_s2_toa_s1_landsat8_landsat9_1proi_v3.json"
...
MAIN_SENSOR="s2_toa"
AUX_SENSOR=("s1" "landsat8" "landsat9")
...
EXP_OUTPUT_PATH="/share/hariharan/cloud_removal/allclear/shared_experiments/benchmark/tx3_s1_d10k_[s1s2ls]"
#EXP_NAME="tx3_s1_d10k_[s2]"
#EXP_NAME="tx3_s1_d10k"
EXP_NAME="tx3_s1_d10k_[s1s2ls]"
