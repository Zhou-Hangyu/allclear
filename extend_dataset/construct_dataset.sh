...
#'/share/hariharan/cloud_removal/metadata/v4/landsat8_test_3k_metadata.csv'
#'/share/hariharan/cloud_removal/metadata/v4/landsat9_test_3k_metadata.csv'
...
VERSION="v4"  # testing random stuff

#python dataset/construct_dataset_mp_s1copy.py \
