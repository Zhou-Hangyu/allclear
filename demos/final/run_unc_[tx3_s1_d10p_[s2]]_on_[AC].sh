...
# Command: bash demos/final/run_unc_[tx3_s1_d10k_[s2]]_on_[AC].sh
...
#EXP_OUTPUT_PATH="/share/hariharan/cloud_removal/allclear/shared_experiments/benchmark/tx3_s1_d10k_[s2]"
