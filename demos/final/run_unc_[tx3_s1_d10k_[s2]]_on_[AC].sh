...
# Command: bash demos/final/run_unc_[tx3_s1_d10p_[s2]]_on_[AC].sh
...
#DATASET_PATH="/share/hariharan/cloud_removal/metadata/v4/s2p_tx3_test_3k_s2_toa_s1_v4_s1loose_1proi.json"
...
EXP_OUTPUT_PATH="/share/hariharan/cloud_removal/allclear/shared_experiments/benchmark/tx3_s1_d10p_[s2]"
#EXP_OUTPUT_PATH="/share/hariharan/cloud_removal/allclear/shared_experiments/benchmark/tx3_s1_d10k_[s2]_s1loose"

#EXP_OUTPUT_PATH="/share/hariharan/cloud_removal/results/baselines_v2/uncrtaints_1proi_v2/[tx3_s1_d100p]_on_[AC]"
EXP_NAME="tx3_s1_d10p_[s2]"
